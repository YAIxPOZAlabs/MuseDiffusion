...
if __name__ == '__main__':
    ...
    parser.add_argument('--step', type=int, default=100, help='if less than diffusion training steps, like 1000, use ddim sampling')
    ...
    for lst in glob.glob(args.model_dir):
        ...
        for checkpoint_one in checkpoints:
            ...
            f'--batch_size {args.bsz} --sample_seed {args.seed} --split {args.split} ' \
